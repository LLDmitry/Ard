...
const unsigned long CHECK_NASOS_IMPULSE_PERIOD_S  = 10;     //период контроля импульсов насоса, подсчета импульсов внутри периода(для контроля включенной автономки)
