...
const unsigned long periodGsmCheckSec = 5;
unsigned long currTime;
unsigned long loopTimeGsmCheck;
...
{ 
   ...
   currTime = millis();
   if (currTime-loopTimeGsmCheck >= periodGsmCheckSec * 1000)
   {
    Serial.println("GSM check");
    loopTimeGsmCheck = currTime;

    // в течении секунды опрашиваем GPS
