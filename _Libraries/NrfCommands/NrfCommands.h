...
const uint64_t ArRoomsReadingPipes[] = {0xE8E8F0F0AALL, 0xE8E8F0F0A1LL, 0xE8E8F0F0A2LL, 0xE8E8F0F0A3LL, 0xE8E8F0F0A4LL};
const uint8_t ChannelNRF = 0x60;

enum enRequestCommand { RQ_NO, RQ_T_INFO, RQ_CLOSE_VODA_1, RQ_CLOSE_VODA_2, RQ_ALARM_SHORT, RQ_ALARM_LONG };
